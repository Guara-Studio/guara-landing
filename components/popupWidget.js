  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-orange-500 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-orange-600 focus:bg-orange-600 ease">
                  ...
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                              ...
                              : "border-gray-300 focus:border-orange-600 ring-orange-100"
                          }`}
                        />
                        {errors.name && (
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-orange-500 rounded-md focus:bg-orange-600 focus:outline-none">
                          {isSubmitting ? (
                            <svg
                  ...
                  {isSubmitSuccessful && isSuccess && (
                    <>
                      <div className="flex flex-col items-center justify-center h-full text-center text-white rounded-md">
                        ...
                        <button
                          className="mt-6 text-orange-600 focus:outline-none"
                          onClick={() => reset()}>
                          Go back
                        </button>
                      </div>
